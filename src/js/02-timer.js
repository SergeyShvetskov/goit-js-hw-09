...
// до певної дати.Такий таймер може використовуватися у
// блогах та інтернет - магазинах, сторінках реєстрації
// подій, під час технічного обслуговування тощо.Подивися
// демо - відео роботи таймера.
...
// користувачеві кросбраузерно вибрати кінцеву дату і час в
// одному елементі інтерфейсу.Для того щоб підключити CSS
// код бібліотеки в проект, необхідно додати ще один імпорт,
...
// можна передати необов'язковий об'єкт параметрів.Ми
// підготували для тебе об'єкт, який потрібен для виконання
// завдання.Розберися, за що відповідає кожна властивість в
...
// Вибір дати
// + Метод onClose() з об'єкта параметрів викликається щоразу
// під час закриття елемента інтерфейсу, який створює flatpickr.
...
// + Натисканням на кнопку «Start» починається відлік часу до
// обраної дати з моменту натискання.
// Відлік часу
// + Натисканням на кнопку «Start» скрипт повинен обчислювати
// раз на секунду, скільки часу залишилось до вказаної дати,
// і оновлювати інтерфейс таймера, показуючи чотири цифри:
// дні, години, хвилини і секунди у форматі xx: xx: xx: xx.
...
// до кінцевої дати.Зверни увагу, що вона не форматує результат.Тобто,
// якщо залишилося 4 хвилини або будь - якої іншої складової часу,
// то функція поверне 4, а не 04.В інтерфейсі таймера необхідно
// додавати 0, якщо в числі менше двох символів.Напиши функцію
// addLeadingZero(value), яка використовує метод padStart() і перед
// рендерингом інтефрейсу форматує значення.
